...
class Drone:
 ...
 # Required before start
    ...
    async def send_body_velocity(self, forward_m_s, right_m_s, down_m_s, yawspeed_deg_s):
        """Body-frame velocity setpoint — naturally aligned with the
        forward-facing depth camera, immune to NED EKF rotation drift."""
